...
namespace Hellmade.Sound
{
    ...
    public class Audio
    {
        ...
        public Audio(AudioType audioType, AudioClip clip, bool loop, bool persist, float volume, float fadeInValue, float fadeOutValue, Transform sourceTransform, bool randomPitch)
        {
            // Set unique audio ID
            ...
            Mute = false;
            Priority = 128;
            Pitch = randomPitch ? Random.Range(0.9f, 1.1f) : 1;
            StereoPan = 0;
